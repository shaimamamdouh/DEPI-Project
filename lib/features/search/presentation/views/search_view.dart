...
//import 'package:readio/features/home/presentation/manager/your_books_cubit/cubit/search_cubit.dart';
                    ...
                    return Center(
                      child: Column(
                        ...
                        children: [
                          ...
                          ElevatedButton(
                            onPressed: () {
                              context.read<SearchCubit>().searchBooks(_searchController.text);
                            },
  ...
  Widget build(BuildContext context) {
    ...
    return Card(
      ...
      child: ListTile(
        ...
        trailing: book.previewLink != null && book.previewLink!.isNotEmpty
